This repository is meant to host pre-compiled versions of The Macro Assembler AS by Alfred Arnold, so [MegaEnvironment](https://github.com/Franklin0770/megaenvironment) can download them without problems.  
